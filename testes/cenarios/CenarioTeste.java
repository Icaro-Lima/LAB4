...
public class CenarioTeste {
	...
	cenario = new Cenario("Ícaro vai tirar 10,0 nesse lab.");
    }
	...
	assertEquals("Problema na inicialização ou no toString", "Ícaro vai tirar 10,0 nesse lab. - Não finalizado",
		cenario.toString());
    }
	...
	assertEquals("Problema no toString", "Ícaro vai tirar 10,0 nesse lab. - Não finalizado",
	...
	assertEquals(99999999, this.cenario.getCaixaCenario());
