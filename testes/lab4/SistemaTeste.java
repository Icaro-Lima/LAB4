...
public class SistemaTeste {
	...
	public void testCadastrarCenarioEExibirCenarioEFecharAposta() {
		...
		assertEquals("1 - A Red Cannids vai pro mundial. - Nao finalizado", this.sistema.exibirCenario(1));
	...
	/**
	 * Testa o método exibirCenarios (que deve retornar a representação textual de
	 * todos os cenários no sistema).
	 */
	@Test
	...
	public void testGetCaixaCenarioEGetTotalRateioCenario() {
		...
		assertEquals(999999, this.sistema.getCaixaCenario(1));
		...
		this.sistema.fecharAposta(3, false);
		assertEquals(10099, this.sistema.getCaixaCenario(3));
		assertEquals(0, this.sistema.getTotalRateioCenario(3));

		assertEquals(999999 + 10099, this.sistema.getCaixa());
	}
	...
	/**
	 * Testa as ordenações dos cenários.
	 */
	@Test
	public void testOrdenaCenarios() {
		this.sistema.cadastrarCenario("Minha net não vai cair hoje!");
		this.sistema.cadastrarCenario("A energia não vai cair hoje!");
		this.sistema.cadastrarCenario("Alguma coisa.");
		this.sistema.cadastrarCenario("Olar!");
		
		this.sistema.alterarOrdem("Cadastro");
		assertEquals("1 - Minha net não vai cair hoje! - Nao finalizado", this.sistema.exibirCenarioOrdenado(1));
		assertEquals("3 - Alguma coisa. - Nao finalizado", this.sistema.exibirCenarioOrdenado(3));
		assertEquals("2 - A energia não vai cair hoje! - Nao finalizado", this.sistema.exibirCenarioOrdenado(2));
		assertEquals("4 - Olar! - Nao finalizado", this.sistema.exibirCenarioOrdenado(4));

		this.sistema.alterarOrdem("Nome");
		assertEquals("1 - A energia não vai cair hoje! - Nao finalizado", this.sistema.exibirCenarioOrdenado(1));
		assertEquals("3 - Minha net não vai cair hoje! - Nao finalizado", this.sistema.exibirCenarioOrdenado(3));
		assertEquals("2 - Alguma coisa. - Nao finalizado", this.sistema.exibirCenarioOrdenado(2));
		assertEquals("4 - Olar! - Nao finalizado", this.sistema.exibirCenarioOrdenado(4));
